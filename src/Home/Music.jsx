...
import frameImg from '../assets/Frame 600.png';
...
const Music = () => {
  ...
  return (
    <div>
      <Container>
       <div style={{ backgroundImage: `url(${frameImg})` }} className="p-17.5 bg-cover bg-center bg-no-repeat ">
          
          <div className="  ">
            <h6 className=" text-[12px] text-[#00FF66] ">Categories</h6>
            <h2 className=" font-medium py-4 lg:8 leading-8 lg:leading-15 text-2xl lg:text-5xl  text-white w-111 ">
