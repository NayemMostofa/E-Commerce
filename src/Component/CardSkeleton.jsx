...
<div className="relative flex flex-col mt-6 text-gray-700  rounded-xl w-67.5 animate-pulse">
  <div className="relative grid h-56  mt-4 overflow-hidden text-gray-700 bg-gray-300 bg-clip-border rounded-xl place-items-center">
